...
def test_valid_days_in_february() -> None:
...
last_year_beginning = int(datetime(2106, 1, 1, 0, 0, 0, tzinfo=timezone.utc).timestamp())
last_year_end = int(datetime(2106, 12, 31, 23, 59, 59, tzinfo=timezone.utc).timestamp())
